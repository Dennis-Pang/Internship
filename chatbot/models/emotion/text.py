...
TEXT_EMOTION_LABELS = EMOTION_LABELS
...
def predict_text_emotion(text: str, return_logits: bool = False) -> Dict[str, float]:
    ...
    try:
        ...
        if return_logits:
            ...
            scores = {
                EMOTION_LABELS[i]: float(logits_np[i])
        ...
        return validate_emotion_scores(scores)

    except Exception as exc:
        return handle_emotion_prediction_error(exc, "Text emotion", return_logits)
