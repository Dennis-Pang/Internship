...
def chat(
    ...
    if memobase_context is None:
        tracker.record("llm_memory_fetch", time.perf_counter() - prep_start)
    ...
    if stream:
        ...
        for chunk in response:
            ...
            if not first_token_received:
                ...
                tracker.record("llm_first_token", first_token_time)
        ...
        tracker.record("llm_inference", total_inference_time)
    else:
        if response.choices:
